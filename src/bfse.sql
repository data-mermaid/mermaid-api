SELECT "belt_fish_se_sm"."id", "belt_fish_se_sm"."project_id", "belt_fish_se_sm"."project_name", "belt_fish_se_sm"."project_status", "belt_fish_se_sm"."project_notes", "belt_fish_se_sm"."contact_link", "belt_fish_se_sm"."tags", "belt_fish_se_sm"."site_id", "belt_fish_se_sm"."site_name", "belt_fish_se_sm"."location"::bytea, "belt_fish_se_sm"."longitude", "belt_fish_se_sm"."latitude", "belt_fish_se_sm"."site_notes", "belt_fish_se_sm"."country_id", "belt_fish_se_sm"."country_name", "belt_fish_se_sm"."reef_type", "belt_fish_se_sm"."reef_zone", "belt_fish_se_sm"."reef_exposure", "belt_fish_se_sm"."management_id", "belt_fish_se_sm"."management_name", "belt_fish_se_sm"."management_name_secondary", "belt_fish_se_sm"."management_est_year", "belt_fish_se_sm"."management_size", "belt_fish_se_sm"."management_parties", "belt_fish_se_sm"."management_compliance", "belt_fish_se_sm"."management_rules", "belt_fish_se_sm"."management_notes", "belt_fish_se_sm"."sample_date", "belt_fish_se_sm"."sample_event_id", "belt_fish_se_sm"."sample_event_notes", "belt_fish_se_sm"."sample_unit_count", "belt_fish_se_sm"."depth_avg", "belt_fish_se_sm"."depth_sd", "belt_fish_se_sm"."current_name", "belt_fish_se_sm"."tide_name", "belt_fish_se_sm"."visibility_name", "belt_fish_se_sm"."biomass_kgha_avg", "belt_fish_se_sm"."biomass_kgha_sd", "belt_fish_se_sm"."biomass_kgha_by_trophic_group_avg", "belt_fish_se_sm"."biomass_kgha_by_trophic_group_sd", "belt_fish_se_sm"."biomass_kgha_by_fish_family_avg", "belt_fish_se_sm"."biomass_kgha_by_fish_family_sd", "belt_fish_se_sm"."data_policy_beltfish" FROM (
        WITH beltfish_su AS (
    ...
    WHERE
        1 = 1 AND project.id = '75ef7a5a-c770-4ca6-b9f8-830cab74e425'::uuid
        ...
        SELECT o.id, pseudosu_id,
            se.project_id, se.project_name, se.project_status, se.project_notes, se.contact_link, se.tags, se.site_id, se.site_name, se.location, se.longitude, se.latitude, se.site_notes, se.country_id, se.country_name, se.reef_type, se.reef_zone, se.reef_exposure, se.management_id, se.management_name, se.management_name_secondary, se.management_est_year, se.management_size, se.management_parties, se.management_compliance, se.management_rules, se.management_notes, se.sample_event_id, se.sample_date, se.sample_event_notes,
    ...
    ,
        ...
        project_id, project_name, project_status, project_notes, contact_link, tags, site_id, site_name, location, longitude, latitude, site_notes, country_id, country_name, reef_type, reef_zone, reef_exposure, management_id, management_name, management_name_secondary, management_est_year, management_size, management_parties, management_compliance, management_rules, management_notes, sample_event_id, sample_date, sample_event_notes, depth, transect_number, transect_len_surveyed, data_policy_beltfish,
        beltfish_su.sample_unit_ids, label, relative_depth, sample_time, observers, current_name, tide_name, visibility_name, sample_unit_notes,
        reef_slope,
        transect_width_name,
        size_bin,
        total_abundance,
        ...
        FROM (
            ...
            beltfish_obs.project_id, beltfish_obs.project_name, beltfish_obs.project_status, beltfish_obs.project_notes, beltfish_obs.contact_link, beltfish_obs.tags, beltfish_obs.site_id, beltfish_obs.site_name, beltfish_obs.location, beltfish_obs.longitude, beltfish_obs.latitude, beltfish_obs.site_notes, beltfish_obs.country_id, beltfish_obs.country_name, beltfish_obs.reef_type, beltfish_obs.reef_zone, beltfish_obs.reef_exposure, beltfish_obs.management_id, beltfish_obs.management_name, beltfish_obs.management_name_secondary, beltfish_obs.management_est_year, beltfish_obs.management_size, beltfish_obs.management_parties, beltfish_obs.management_compliance, beltfish_obs.management_rules, beltfish_obs.management_notes, beltfish_obs.sample_event_id, beltfish_obs.sample_date, beltfish_obs.sample_event_notes, beltfish_obs.depth, beltfish_obs.transect_number, beltfish_obs.transect_len_surveyed, beltfish_obs.data_policy_beltfish,
 ...
 '::text) AS sample_unit_notes
    ,
        ...
        beltfish_su.project_id, beltfish_su.project_name, beltfish_su.project_status, beltfish_su.project_notes, beltfish_su.contact_link, beltfish_su.tags, beltfish_su.site_id, beltfish_su.site_name, beltfish_su.location, beltfish_su.longitude, beltfish_su.latitude, beltfish_su.site_notes, beltfish_su.country_id, beltfish_su.country_name, beltfish_su.reef_type, beltfish_su.reef_zone, beltfish_su.reef_exposure, beltfish_su.management_id, beltfish_su.management_name, beltfish_su.management_name_secondary, beltfish_su.management_est_year, beltfish_su.management_size, beltfish_su.management_parties, beltfish_su.management_compliance, beltfish_su.management_rules, beltfish_su.management_notes, beltfish_su.sample_event_id, beltfish_su.sample_date, beltfish_su.sample_event_notes,
        data_policy_beltfish,
