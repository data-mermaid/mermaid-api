...
class FishAttributeView(FishAttribute):
    sql = """
CREATE MATERIALIZED VIEW IF NOT EXISTS mv_fish_attributes
 AS
...
CREATE UNIQUE INDEX fish_attributes_id
    ON mv_fish_attributes USING btree
    (id ASC NULLS LAST)
...
;
    ...
    reverse_sql = """
      DROP MATERIALIZED VIEW IF EXISTS mv_fish_attributes;
    """
