...
class BenthicAttributeUpdateGenerator(object):
    ...
    def update(self):
        ...
        cuke = BenthicAttribute.objects.create(name='Sea cucumber', parent=self.otherinvert)
        urchin = BenthicAttribute.objects.create(name='Sea urchin', parent=self.otherinvert)
