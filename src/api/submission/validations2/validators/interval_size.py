...
class IntervalSizeValidator(BaseValidator):
    ...
    def __call__(self, collect_record, **kwargs):
        ...
        try:
            ...
            return ERROR, self.INVALID_INTERVAL_SIZE, {"interval_size_range": self.INTERVAL_SIZE_RANGE}

        if interval_size <= self.INTERVAL_SIZE_RANGE[0]:
            return ERROR, self.INVALID_INTERVAL_SIZE, {"interval_size_range": self.INTERVAL_SIZE_RANGE}
        elif interval_size > self.INTERVAL_SIZE_RANGE[1]:
            return ERROR, self.EXCEED_MAX_INTERVAL_SIZE, {"interval_size_range": self.INTERVAL_SIZE_RANGE}
