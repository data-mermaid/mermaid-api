...
class UniqueInvertBeltTransectValidator(BaseValidator):
    INVALID_DATA = "invalid_invert_belt_transect"
    DUPLICATE_INVERT_BELT_TRANSECT = "duplicate_invert_belt_transect"
    ...
    def _check_for_duplicate_transect_methods(self, transect_methods, protocol):
        for transect_method in transect_methods:
            if transect_method.protocol == protocol:
                return (
                    ERROR,
                    self.DUPLICATE_INVERT_BELT_TRANSECT,
