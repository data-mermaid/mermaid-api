...
def test_delete_orphaned_sample_unit_clean_orphaned(
    ...
    assert (
        delete_orphaned_sample_unit(benthic_transect1, deleted_tm=benthic_lit1) is True
    )
...
def test_delete_orphaned_sample_unit_not_cleaned_orphaned(
    ...
    assert (
        delete_orphaned_sample_unit(benthic_transect1, deleted_tm=benthic_lit1) is False
    )
