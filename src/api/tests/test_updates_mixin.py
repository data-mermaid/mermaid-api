...
class UpdatesMixinTestCase(TestCase):
    def test_compress(self):
        added = [
            ...
            dict(id=10, updated_on=str(datetime(2019, 1, 1, 1, 1, 1))),  # Removed
            dict(id=11, updated_on=str(datetime(2019, 1, 1, 1, 1, 1))),  # Removed
            dict(id=12, updated_on=str(datetime(2019, 1, 1, 1, 1, 1))),
        ]

        modified = [
            dict(id=2, updated_on=str(datetime(2019, 1, 1, 1, 1, 5))),  # Removed
        ...
        deleted = [
            ...
            dict(id=5, timestamp=datetime(2019, 1, 1, 1, 1, 0)),  # Removed
            dict(id=10, timestamp=datetime(2019, 1, 1, 1, 1, 1)),
            dict(id=11, timestamp=datetime(2019, 1, 1, 1, 1, 2)),
            dict(id=12, timestamp=datetime(2019, 1, 1, 1, 1, 0)),  # Removed
        ]
