...
def benthic_attribute_2(db, region2, region3):
    ba = BenthicAttribute.objects.create(status=SUPERUSER_APPROVED, name="Hard coral")
    ba.regions.add(region2)
...
def benthic_attribute_3(db, region1, region2, region3):
    ba = BenthicAttribute.objects.create(status=SUPERUSER_APPROVED, name="Rock")
    ba.regions.add(region1)
    ba.regions.add(region2)
    ba.regions.add(region3)
...
def benthic_attribute_4(db, region1, region2, region3):
    ba = BenthicAttribute.objects.create(status=SUPERUSER_APPROVED, name="Sand")
    ba.regions.add(region1)
    ba.regions.add(region2)
    ba.regions.add(region3)
...
def benthic_attribute_1a(db, benthic_attribute_1, region3):
    ba = BenthicAttribute.objects.create(
        status=SUPERUSER_APPROVED, name="Red Fleshy Algae", parent=benthic_attribute_1
    )
    ba.regions.add(region3)
...
def benthic_attribute_2a(db, benthic_attribute_2, region2, all_life_histories):
    ba = BenthicAttribute.objects.create(
        status=SUPERUSER_APPROVED, name="Acroporidae", parent=benthic_attribute_2
    )
    ba.regions.add(region2)
...
def benthic_attribute_2b(db, benthic_attribute_2, region3):
    ba = BenthicAttribute.objects.create(
        status=SUPERUSER_APPROVED, name="Faviidae", parent=benthic_attribute_2
    )
    ba.regions.add(region3)
...
def benthic_attribute_2a1(db, benthic_attribute_2a):
    return BenthicAttribute.objects.create(
        status=SUPERUSER_APPROVED, name="Astreopora", parent=benthic_attribute_2a
    )
...
def benthic_attribute_2b1(db, benthic_attribute_2b, region1, region3):
    ba = BenthicAttribute.objects.create(
        status=SUPERUSER_APPROVED, name="Porites evermanni", parent=benthic_attribute_2b
    )
    ba.regions.add(region1)
    ba.regions.add(region3)
