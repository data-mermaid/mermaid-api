...
def test_beltfish_se_view(
    ...
    assert data[0]["biomass_kgha_trophic_group_avg"]["omnivore"] == pytest.approx(obs_belt_fish1_1_biomass, 0.1)

    fish_family_biomass_avg_0 = data[0]["biomass_kgha_fish_family_avg"]
...
def test_benthicpit_se_view(
    ...
    assert data[0]["percent_cover_benthic_category_avg"]["Macroalgae"] == 40.0
    assert data[0]["percent_cover_benthic_category_sd"]["Macroalgae"] == 28.28
    assert data[0]["percent_cover_benthic_category_avg"]["Hard coral"] == 50.0
    assert data[0]["percent_cover_benthic_category_sd"]["Hard coral"] == 14.14
    assert data[0]["percent_cover_benthic_category_avg"]["Rock"] == 10.0
    assert data[0]["percent_cover_benthic_category_sd"]["Rock"] == 14.14

    assert data[1]["percent_cover_benthic_category_avg"]["Hard coral"] == 60.0
    assert data[1]["percent_cover_benthic_category_avg"]["Rock"] == 40.0
...
def test_benthiclit_se_view(
    ...
    assert count == 2
    assert data[0]["percent_cover_benthic_category_avg"]["Macroalgae"] == 16.92
    assert data[0]["percent_cover_benthic_category_avg"]["Hard coral"] == 60.0
    assert data[0]["percent_cover_benthic_category_avg"]["Rock"] == 23.08

    assert data[1]["percent_cover_benthic_category_avg"]["Hard coral"] == 58.46
    assert data[1]["percent_cover_benthic_category_avg"]["Rock"] == 41.54
