# Generated by Django 3.2.16 on 2023-02-09 12:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_time', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent_normal_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_pale_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_bleached_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('quadrat_count_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_hard_avg_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_soft_avg_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_algae_avg_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('data_policy_bleachingqc', models.CharField(max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent_normal', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_pale', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_bleached', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('quadrat_count', models.PositiveSmallIntegerField(default=0)),
                ('percent_hard_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_soft_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('percent_algae_avg', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True)),
                ('data_policy_bleachingqc', models.CharField(max_length=50)),
                ('pseudosu_id', models.UUIDField()),
            ],
            options={
