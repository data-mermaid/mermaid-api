# Generated by Django 2.2.12 on 2021-03-29 23:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('est_year', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(2021)], verbose_name='year established')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('sample_date', models.DateField(blank=True, default=api.models.mermaid.default_date, null=True)),
                ('notes', models.TextField(blank=True)),
                ('sample_time', models.TimeField(blank=True, null=True)),
                ('depth', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(40)], verbose_name='depth (m)')),
                ('validations', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=rest_framework.utils.encoders.JSONEncoder, null=True)),
                ...
                ('management', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='api.Management')),
                ('relative_depth', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.RelativeDepth')),
                ('site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sample_events', to='api.Site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('size_bin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='api.FishSizeBin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('quadrat_number', models.PositiveSmallIntegerField(verbose_name='quadrat number')),
                ('percent_hard', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='hard coral, % cover')),
                ('percent_soft', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='soft coral, % cover')),
                ('percent_algae', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='macroalgae, % cover')),
