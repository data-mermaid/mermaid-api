    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('est_year', models.PositiveSmallIntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(2022)], verbose_name='year established')),
                ...
                ('periodic_closure', models.BooleanField(default=False, verbose_name='periodic closure')),
                ...
                ('gear_restriction', models.BooleanField(default=False, verbose_name='partial gear restriction')),
                ('species_restriction', models.BooleanField(default=False, verbose_name='partial species restriction')),
                ('access_restriction', models.BooleanField(default=False, verbose_name='access restriction')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_policy_bleachingqc', models.PositiveSmallIntegerField(choices=[(10, 'private'), (50, 'public summary'), (100, 'public')], default=50)),
                ('data_policy_benthicpqt', models.PositiveSmallIntegerField(choices=[(10, 'private'), (50, 'public summary'), (100, 'public')], default=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='project_created_by', to='api.Profile')),
            ],
            options={
                'db_table': 'project',
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('val', models.PositiveSmallIntegerField()),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reefexposure_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reeftype_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reefzone_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(90, 'superuser approved'), (10, 'proposed')], default=10)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tag_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transectmethod_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transectmethod_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('val', models.PositiveSmallIntegerField()),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='visibility_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tide_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='site_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('validations', django.contrib.postgres.fields.jsonb.JSONField(blank=True, encoder=rest_framework.utils.encoders.JSONEncoder, null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sampleevent_created_by', to='api.Profile')),
                ('management', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.Management')),
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sample_events', to='api.Site')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sampleevent_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='relativedepth_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='region_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=50)),
                ('val', models.PositiveSmallIntegerField()),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reefslope_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('len_surveyed', models.DecimalField(decimal_places=1, max_digits=4, verbose_name='transect length surveyed (m)')),
                ...
                ('num_quadrats', models.PositiveSmallIntegerField()),
                ('num_points_per_quadrat', models.PositiveSmallIntegerField()),
                ('quadrat_number_start', models.PositiveSmallIntegerField(default=1, verbose_name='number of first quadrat')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quadrattransect_created_by', to='api.Profile')),
                ('current', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Current')),
                ('reef_slope', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.ReefSlope')),
                ('relative_depth', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.RelativeDepth')),
                ('sample_event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.SampleEvent')),
                ('tide', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Tide')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quadrattransect_updated_by', to='api.Profile')),
                ('visibility', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Visibility')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quadrat_size', models.DecimalField(decimal_places=2, default=1, max_digits=6, validators=[django.core.validators.MinValueValidator(0)], verbose_name='single quadrat area (m2)')),
                ('label', models.CharField(blank=True, max_length=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quadratcollection_created_by', to='api.Profile')),
                ('current', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Current')),
                ('relative_depth', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.RelativeDepth')),
                ('sample_event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.SampleEvent')),
                ('tide', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Tide')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mpa_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mpa_updated_by', to='api.Profile')),
            ],
            options={
                'verbose_name': 'MPA',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managementparty_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managementparty_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managementcompliance_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='managementcompliance_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('val', models.PositiveSmallIntegerField()),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='habitatcomplexityscore_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='habitatcomplexityscore_updated_by', to='api.Profile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='growthform_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='growthform_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishsizebin_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishsizebin_updated_by', to='api.Profile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishsize_created_by', to='api.Profile')),
                ('fish_bin_size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.FishSizeBin')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishsize_updated_by', to='api.Profile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishgrouptrophic_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishgrouptrophic_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishgroupsize_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishgroupsize_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('description', models.TextField(blank=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishgroupfunction_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishgroupfunction_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.PositiveSmallIntegerField(default=1)),
                ('label', models.CharField(blank=True, max_length=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishbelttransect_created_by', to='api.Profile')),
                ('current', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Current')),
                ('reef_slope', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.ReefSlope')),
                ('relative_depth', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.RelativeDepth')),
                ('sample_event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.SampleEvent')),
                ('size_bin', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.FishSizeBin')),
                ('tide', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Tide')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fishbelttransect_updated_by', to='api.Profile')),
                ('visibility', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Visibility')),
                ('width', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.BeltTransectWidth', verbose_name='width (m)')),
            ],
            options={
                'verbose_name': 'fish belt transect',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collectrecord_created_by', to='api.Profile')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collect_records', to='api.Profile')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='collect_records', to='api.Project')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='collectrecord_updated_by', to='api.Profile')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.PositiveSmallIntegerField(default=1)),
                ('label', models.CharField(blank=True, max_length=50)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='benthictransect_created_by', to='api.Profile')),
                ('current', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Current')),
                ('reef_slope', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.ReefSlope')),
                ('relative_depth', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.RelativeDepth')),
                ('sample_event', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.SampleEvent')),
                ('tide', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Tide')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='benthictransect_updated_by', to='api.Profile')),
                ('visibility', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.Visibility')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(max_length=100)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='benthiclifehistory_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='benthiclifehistory_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(90, 'superuser approved'), (10, 'proposed')], default=10)),
                ('name', models.CharField(max_length=100)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='benthicattribute_created_by', to='api.Profile')),
                ('life_history', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.BenthicLifeHistory')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='api.BenthicAttribute')),
                ('regions', models.ManyToManyField(blank=True, to='api.Region')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='benthicattribute_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='projectprofile_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='observer_created_by', to='api.Profile')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.Profile')),
                ('transectmethod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='observers', to='api.TransectMethod', verbose_name='transect method')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='observer_updated_by', to='api.Profile')),
            ],
            options={
                'db_table': 'observer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obscoloniesbleached_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.BenthicAttribute')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obsbenthiclit_created_by', to='api.Profile')),
                ('growth_form', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.GrowthForm')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obsbenthiclit_updated_by', to='api.Profile')),
                ('benthiclit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='obsbenthiclit_set', to='api.BenthicLIT')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include', models.BooleanField(default=True, verbose_name='include observation in aggregations/analyses?')),
                ('notes', models.TextField(blank=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obsbeltfish_created_by', to='api.Profile')),
                ('fish_attribute', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.FishAttribute')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obsbeltfish_updated_by', to='api.Profile')),
                ('beltfish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='beltfish_observations', to='api.BeltFish')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mpa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mpa_zones', to='api.MPA')),
            ],
            options={
                'db_table': 'mpa_zone',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transect', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='habitatcomplexity_method', to='api.BenthicTransect', verbose_name='benthic transect')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('functional_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.FishGroupFunction')),
                ('genus', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.FishGenus')),
                ('group_size', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.FishGroupSize')),
                ('regions', models.ManyToManyField(blank=True, to='api.Region')),
                ('trophic_group', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.FishGroupTrophic')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interval_size', models.DecimalField(decimal_places=2, default=0.5, max_digits=4, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(10)], verbose_name='interval size (m)')),
                ('interval_start', models.DecimalField(decimal_places=2, default=0.5, max_digits=4, verbose_name='interval start (m)')),
                ('transect', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='benthicpit_method', to='api.BenthicTransect', verbose_name='benthic transect')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
                ('operator', models.CharField(blank=True, choices=[('==', '=='), ('!=', '!='), ('<', '<'), ('<=', '<='), ('>', '>'), ('>=', '>=')], max_length=2, null=True)),
                ('size', models.DecimalField(blank=True, decimal_places=1, max_digits=5, null=True, verbose_name='fish size (cm)')),
                ('val', models.PositiveSmallIntegerField()),
                ('belttransectwidth', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='conditions', to='api.BeltTransectWidth')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='belttransectwidthcondition_created_by', to='api.Profile')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='belttransectwidthcondition_updated_by', to='api.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('quadrat_number', models.PositiveSmallIntegerField(verbose_name='quadrat number')),
                ('percent_hard', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='hard coral, % cover')),
                ('percent_soft', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='soft coral, % cover')),
                ('percent_algae', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True, verbose_name='macroalgae, % cover')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obsquadratbenthicpercent_created_by', to='api.Profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('include', models.BooleanField(default=True, verbose_name='include observation in aggregations/analyses?')),
                ('notes', models.TextField(blank=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obshabitatcomplexity_created_by', to='api.Profile')),
                ('score', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.HabitatComplexityScore')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obshabitatcomplexity_updated_by', to='api.Profile')),
                ('habitatcomplexity', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='habitatcomplexity_set', to='api.HabitatComplexity')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('attribute', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='api.BenthicAttribute')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obsbenthicpit_created_by', to='api.Profile')),
                ('growth_form', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.GrowthForm')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='obsbenthicpit_updated_by', to='api.Profile')),
                ('benthicpit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='obsbenthicpit_set', to='api.BenthicPIT')),
            ],
            options={
