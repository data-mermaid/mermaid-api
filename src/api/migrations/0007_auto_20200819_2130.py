...
from ..models.view_models import model_view_migrations, BeltFishSUView, BenthicLITSUView, BenthicPITSUView
...
INSERT INTO sample_unit_cache
WITH se_pseudosu_ids_bp AS (
    SELECT
    uuid_generate_v4() AS pseudosu_id,
    array_agg(DISTINCT sample_unit_id) AS sample_unit_ids,
    sample_event_id
    FROM vw_benthicpit_obs
    GROUP BY {benthicpit_fields}
)
SELECT 
UNNEST(sample_unit_ids) AS sample_unit_id,
pseudosu_id,
sample_event_id
FROM se_pseudosu_ids_bp
ON CONFLICT DO NOTHING;
""".format(
